...
"""a collection of Subscription-related models"""
...
class SubscriptionLayer(Model, AuditMixinNullable):

    """A logical namespace for a set of annotations"""

    __tablename__ = 'subscription_layer'
...
class Subscription(Model, AuditMixinNullable):

    """Time-related subscription"""

    __tablename__ = 'subscription'
    id = Column(Integer, primary_key=True)
    start_dttm = Column(DateTime)
    end_dttm = Column(DateTime)
    layer_id = Column(Integer, ForeignKey('subscription_layer.id'))
