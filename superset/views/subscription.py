...
class SubscriptionModelView(SupersetModelView, DeleteMixin):  # noqa
...
class SubscriptionLayerModelView(SupersetModelView, DeleteMixin):
...
appbuilder.add_view(
    SubscriptionLayerModelView,
    'Subscriber Layers',
    label=__('Subscriber Layers'),
    icon='fa-comment',
    category='Manage',
