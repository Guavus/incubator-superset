...
export default class SubscriberLayer extends React.PureComponent {
  ...
  applySubscription() {
    if (this.state.name.length && this.state.sliceId) {
      ...
      subscription['useAsModal'] ? subscription['actions'].push('USE_AS_POPUP') : subscription['actions'];
          ...
          <div style={{ marginRight: '2rem' }}>
            ...
            >
              ...
              hovered
                ...
                label="Use as popup"
                description={'If selected, this slice will not available to use in dashboard.'}
                value={useAsModal}
